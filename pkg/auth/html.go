...
func pkgAuthHtmlBasicViewsLoginTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "pkg/auth/html/basic/views/login.tmpl", size: 1069, mode: os.FileMode(438), modTime: time.Unix(1601577976, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
