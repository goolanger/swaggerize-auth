...
// RegisterActivateParams contains all the bound params for the register activate operation
// typically these are obtained from a http.Request
//
// swagger:parameters RegisterActivate
...
//
// To ensure default values, the struct must have been initialized with NewRegisterActivateParams() beforehand.
func (o *RegisterActivateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RegisterActivateParams) bindToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
