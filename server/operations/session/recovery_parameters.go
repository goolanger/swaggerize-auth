...
// RecoveryParams contains all the bound params for the recovery operation
...
//
// To ensure default values, the struct must have been initialized with NewRecoveryParams() beforehand.
func (o *RecoveryParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RecoveryParams) bindToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
