...
// StateParams contains all the bound params for the state operation
...
//
// To ensure default values, the struct must have been initialized with NewStateParams() beforehand.
func (o *StateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *StateParams) bindAction(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *StateParams) validateAction(formats strfmt.Registry) error {
